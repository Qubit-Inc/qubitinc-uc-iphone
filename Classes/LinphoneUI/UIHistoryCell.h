...
@property (weak, nonatomic) IBOutlet UIButton *missedStatus;

@property (weak, nonatomic) IBOutlet UIButton *receivedStatus;

@property (weak, nonatomic) IBOutlet UIButton *sendStatus;
@end
