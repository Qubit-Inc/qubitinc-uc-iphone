...
@property (weak, nonatomic) IBOutlet UIIconButton *statusButton;
...
@property (weak, nonatomic) IBOutlet UILabel *labelKeypad;
@property (weak, nonatomic) IBOutlet UILabel *labelChats;
