...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (@available(iOS 12.0, *)) {
        if( self.traitCollection.userInterfaceStyle == UIUserInterfaceStyleDark ){
            ...
            NSAttributedString *attrStr = [[NSAttributedString alloc] initWithString:_addButton.titleLabel.text  attributes:attributes];
            
            [_addButton setAttributedTitle:attrStr forState:UIControlStateNormal];
        }
        else {
