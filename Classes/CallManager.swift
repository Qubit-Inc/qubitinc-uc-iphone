...
@objc class CallManager: NSObject {
    ...
    @objc func voicemailFilePath(otherparty: String, createdEpoc:String) -> String {
        let writablePath = AppManager.voicemailFilePath(otherparty: otherparty, createdEpoc: createdEpoc)
        return writablePath;
    }
}
