...
@property (weak, nonatomic) IBOutlet UILabel *labelHold;
@property (weak, nonatomic) IBOutlet UILabel *labelMute;
@property (weak, nonatomic) IBOutlet UILabel *labelNewCall;
@property (weak, nonatomic) IBOutlet UILabel *labelConference;
...
@property (weak, nonatomic) IBOutlet UILabel *labelSeaker;
