...
- (void)setFontSize{
    ...
    double buttonFontSize = _fiveButton.frame.size.height * 0.23;
    ...
    _numpadButton.titleLabel.font = [UIFont systemFontOfSize:buttonFontSize];
    
    double labelFontSize = (_fiveButton.frame.size.height * 0.23) * 0.3;
...
- (void) darkmodeApplication {
    ...
    if (@available(iOS 12.0, *)) {
        if( self.traitCollection.userInterfaceStyle == UIUserInterfaceStyleDark ){
            ...
            [_callPauseButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_microButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_optionsAddButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_optionsConferenceButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_optionsTransferButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_videoButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_speakerButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_routesButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_recordButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            
            UIColor *textColor = [UIColor whiteColor];
            [_labelChat setTextColor:textColor];
            [_labelHold setTextColor:textColor];
            [_labelMute setTextColor:textColor];
            [_labelNewCall setTextColor:textColor];
            [_labelConference setTextColor:textColor];
            [_labelTransfer setTextColor:textColor];
            [_labelVideo setTextColor:textColor];
            [_labelRecord setTextColor:textColor];
            [_labelSeaker setTextColor:textColor];
            ...
            NSAttributedString *pauseButtonAttrStr = [[NSAttributedString alloc] initWithString:_callPauseButton.titleLabel.text  attributes:attributes];
            [_callPauseButton setAttributedTitle:pauseButtonAttrStr forState:UIControlStateNormal];
            
            NSAttributedString *microAttrStr = [[NSAttributedString alloc] initWithString:_microButton.titleLabel.text  attributes:attributes];
            [_microButton setAttributedTitle:microAttrStr forState:UIControlStateNormal];
            
            NSAttributedString *videoButtonAttrStr = [[NSAttributedString alloc] initWithString:_videoButton.titleLabel.text  attributes:attributes];
            [_videoButton setAttributedTitle:videoButtonAttrStr forState:UIControlStateNormal];
            
            NSAttributedString *speakerAttrStr = [[NSAttributedString alloc] initWithString:_speakerButton.titleLabel.text  attributes:attributes];
            [_speakerButton setAttributedTitle:speakerAttrStr forState:UIControlStateNormal];
            
            
            
            NSAttributedString *addButtonAttrStr = [[NSAttributedString alloc] initWithString:_optionsAddButton.titleLabel.text  attributes:attributes];
            [_optionsAddButton setAttributedTitle:addButtonAttrStr forState:UIControlStateNormal];
            
            NSAttributedString *transferButtonAttrStr = [[NSAttributedString alloc] initWithString:_optionsTransferButton.titleLabel.text  attributes:attributes];
            [_optionsTransferButton setAttributedTitle:transferButtonAttrStr forState:UIControlStateNormal];
            
            NSAttributedString *conferenceAttrStr = [[NSAttributedString alloc] initWithString:_optionsConferenceButton.titleLabel.text  attributes:attributes];
            [_optionsConferenceButton setAttributedTitle:conferenceAttrStr forState:UIControlStateNormal];
            ...
            [_callPauseButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_microButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_optionsAddButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_optionsConferenceButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_optionsTransferButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_videoButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_speakerButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            [_routesButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
            ...
            [_oneButton setTitleColor:textColor forState:UIControlStateNormal];
            [_twoButton setTitleColor:textColor forState:UIControlStateNormal];
            [_threeButton setTitleColor:textColor forState:UIControlStateNormal];
            [_fourButton setTitleColor:textColor forState:UIControlStateNormal];
            [_fiveButton setTitleColor:textColor forState:UIControlStateNormal];
            [_sixButton setTitleColor:textColor forState:UIControlStateNormal];
            [_sevenButton setTitleColor:textColor forState:UIControlStateNormal];
            [_eightButton setTitleColor:textColor forState:UIControlStateNormal];
            [_nineButton setTitleColor:textColor forState:UIControlStateNormal];
        ...
        NSAttributedString *conferenceAttrStr = [[NSAttributedString alloc] initWithString:_optionsConferenceButton.titleLabel.text  attributes:grayColorAttributes];
        [_optionsConferenceButton setAttributedTitle:conferenceAttrStr forState:UIControlStateDisabled];
    }
}
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation {
    ...
    [_recordButton setHidden:callRecording];
	[self updateCallView];
	LinphoneCall *call = linphone_core_get_current_call(LC) ;
...
- (void)updateCallView {
    ...
    if (videoHidden) {
        pauseFrame.origin.y = 0;//bottomBar.frame.origin.y - pauseFrame.size.height - 60;
    } else {
        pauseFrame.origin.y = 0; //_videoCameraSwitch.frame.origin.y+_videoGroup.frame.origin.y;
    }
    //recordFrame.origin.y = 0; //_bottomBar.frame.origin.y - pauseFrame.size.height - 60;
    _callPauseButton.frame = pauseFrame;
    NSLog(@"%f",_callPauseButton.frame.origin.y);
...
- (void)updateBottomBar:(LinphoneCall *)call state:(LinphoneCallState)state {
    ...
    NSLog(@"_callPauseButton status %@", _callPauseButton.isSelected ? @"Selected" : @"----");
...
-(void)handleActionWhileVideo {
    bool controlsHidden = (_bottomBar.alpha == 0.0);
    [self hideControls:!controlsHidden sender:_oneButton];
}
...
//    if (!videoHidden) {
//        [self handleActionWhileVideo];
//        return;
//    }
	if ([_numpadView isHidden]) {
        [_numpadButton setSelected:TRUE];
